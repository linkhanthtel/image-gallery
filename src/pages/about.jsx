...
function About() {
  return (
    <div>
      <div className='h-fit px-3 md:px-10 text-white w-screen py-5' style={{backgroundImage: `url(${require('../images/image2.jpg')})`, backgroundSize: 'cover', brightness: '50', backgroundPosition: 'center'}}>
        <motion.div 
        ...
        >
          ...
          <div className='flex justify-center items-center'>
            <Link to="/" className='p-3 border-2 border-white rounded-full hover:bg-blue-700'>Try Now</Link>
          </div>
        </motion.div>
        <motion.div 
          // className='border-b border-white'
