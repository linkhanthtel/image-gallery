...
function Support() {
  return (
    <div>
      <div className='px-2 border-b border-black py-10 md:px-10 bg-blue-50 text-center'>
      ...
      <div className='px-2 border-b border-black py-10 md:px-10 bg-blue-50 text-center'>
        ...
        <div className='flex flex-col md:flex-row md:justify-between'>
          <div className='w-full md:w-[50%]'>
            <form className='flex flex-col border-2 border-black p-5'>
              ...
              <button className='mt-4 p-3 rounded-full text-white bg-green-700'>Submit</button>
            </form>
          </div>
